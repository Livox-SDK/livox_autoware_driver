...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.radio_box_localizer = wx.RadioBox(self.tab_setup, wx.ID_ANY, _("Localizer"), choices=[_("Velodyne"), _("Hokuyo 3D URG"), _("Livox")], majorDimension=3, style=wx.RA_SPECIFY_COLS)
